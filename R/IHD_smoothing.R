...
########################################################################################################################
#asthma data
IHD_df = read_excel("~/R projects/PHM/BCC_UOB_air_quality/data/air-quality-related-admissions-by-lsoa-2025.xlsx", 
                       sheet = "IHD")
#lsoa shape
...
write.xlsx(
  ...
  file = "output/air_quality_spatial_Smoothing_IHD.xlsx",
  rowNames = FALSE
)
